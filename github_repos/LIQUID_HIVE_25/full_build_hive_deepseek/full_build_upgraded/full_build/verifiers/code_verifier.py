...
diagnostics.  You can extend these checks with custom unit tests or use
pytest to run tests provided by the user.
"""
...
def run_in_sandbox(code: str, timeout: float = 5.0) -> List[str]:
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        try:
            ...
            if result.returncode != 0:
                failures.extend(result.stdout.strip().splitlines())
        except Exception as exc:
